        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="order-2 lg:order-1 animate-fade-in">
            <div className="mb-6">
              ...
              <p className="text-petGray">As informações abaixo serão usadas para criar a página personalizada.</p>
            </div>
          ...
          <div className="order-1 lg:order-2 animate-fade-in">
            <div className="mb-6">
              ...
              <p className="text-petGray">Veja como sua página ficará antes de finalizar a criação.</p>
            </div>
