      ...
      <div className="container mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-pet-gray">Confiado por milhares de pais de pets</span>
          </div>

          {/* Título principal */}
          <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
            Crie páginas lindas para seu
            <span className="bg-gradient-to-r from-pet-purple to-pet-blue bg-clip-text text-transparent">
              {' '}
              Pet Querido
            </span>
          </h1>
          ...
          {/* Subtítulo */}
          <p className="text-xl text-pet-gray mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-xl px-8 py-3 text-lg border-2 border-pet-purple text-pet-purple hover:bg-pet-purple hover:text-white transition-all duration-200"
            >
              Ver Exemplos
            </Button>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-8 shadow-2xl">
              <div className="aspect-video bg-gradient-to-br from-pet-purple/10 to-pet-blue/10 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  <Heart className="w-16 h-16 text-pet-purple/60 mx-auto mb-4" />
                  <p className="text-pet-gray font-medium">Prévia da página linda do seu pet</p>
                </div>
              </div>
            </div>
